...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	{
		name: "[Gen 3] Snakewood NatDex Ubers",
		mod: 'gen3',
		searchShow: false,
	...
	},
	{
		...
		searchShow: false,
		ruleset: ['Standard', 'Deoxys Camouflage Clause Mod', 'One Baton Pass Clause'],
		banlist: ['Wobbuffet + Leftovers', 'Wynaut + Leftovers', 'Baton Pass', 'A Monster'],
	},
	{
	...
	{
		name: "[Gen 3] Snakewood UUBL",
		mod: 'gen3',
		searchShow: false,
		ruleset: ['[Gen 3] Snakewood OU', '!Accuracy Trap Clause'],
		banlist: [
	...
	{
		name: "[Gen 3] Snakewood Custom Game",
		mod: 'gen3',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 3] Snakewood Doubles Custom Game",
		mod: 'gen3',
		gameType: 'doubles',
		searchShow: false,
		debug: true,
