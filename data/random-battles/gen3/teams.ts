...
export class RandomGen3Teams extends RandomGen4Teams {
	...
	override getPokemonCompatibility(
		...
		const natDex = ['boilbasaur', 'shrivlsaur', 'vivosaur', 'rotmander', 'charmeworm', 'dragon', 'oozle', 'entrailtle', 'bleedoise', 'raticate', 'spearow', 'fearow', 'nidoranf', 'nidorina', 'nidoqueen', 'nidoranm', 'nidorino', 'nidoking', 'cleffa', 'clefairy', 'clefable', 'polihag', 'poliworm', 'poliwraith', 'ponyta', 'rapidash', 'slowpoke', 'slowbro', 'slowking', 'seel', 'dewgong', 'shellder', 'cloyster', 'drowzee', 'hypno', 'krabby', 'kingler', 'exeggcute', 'exeggutor', 'cubone', 'marowak', 'tyrogue', 'hitmonlee', 'hitmonchan', 'hitmontop', 'rhyhorn', 'rhydon', 'chansey', 'blissey', 'tangela', 'grimreaper', 'ironreaper', 'smoochum', 'eyeeye', 'elekid', 'electabugs', 'magby', 'miasmar', 'pinsir', 'lapras', 'eevee', 'vaporeon', 'jolteon', 'flareon', 'toxeon', 'demoneon', 'gorelax', 'articuno', 'zapdos', 'moltres', 'dratini', 'dragonair', 'dragonite', 'cyndaquil', 'quilava', 'typhlosion', 'ledyba', 'ledian', 'spinarak', 'ariados', 'togepi', 'togetic', 'natu', 'xatu', 'wooper', 'quagsire', 'dirtkrow', 'misdreavus', 'wynaut', 'wobbuffet', 'pineco', 'forretress', 'heracross', 'swinub', 'piloswine', 'mantine', 'houndsour', 'headdoom', 'stantler', 'larvitar', 'pupitar', 'tyranitar', 'scarlugia', 'hooh', 'milotic', 'drilbur', 'excadrill', 'shinigami', 'stitcher', 'antispiral', 'fangasu', 'nigera', 'goosuboa', 'amonster', 'rotting', 'kuriputo', 'roodanse', 'ooshe', 'mutagon', 'mewby', 'kamina', 'zombified', 'crazymadio', 'diamandix', 'telson', 'maw', 'kajilianth'];
		// Code below excludes NatDex mons from non-NatDex random battle formats, is commented out because regular random battles will have NatDex mons
		// if (this.format.id !== "gen3nationaldexrandombattle" && natDex.includes(species.id)) return false;
