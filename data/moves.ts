...
export const Moves: import('../sim/dex-moves').MoveDataTable = {
	...
	skullbreaker: {
		...
		category: "Physical",
		name: "Skullbreaker",
		desc: "40% chance to paralyze the target.",
		pp: 10,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, metronome: 1 },
		secondary: {
	...
	firepump: {
		...
		category: "Special",
		name: "Fire Pump",
		desc: "40% chance to burn the target.",
		pp: 8,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
		secondary: {
	...
	crazybolt: {
		...
		category: "Special",
		name: "Crazy Bolt",
		desc: "50% chance to lower the target's Attack by 1.",
		pp: 5,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
		secondary: {
	...
	poisonslash: {
		...
		category: "Physical",
		name: "Poison Slash",
		desc: "10% chance to poison the target.",
		pp: 15,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, metronome: 1 },
		secondary: {
	...
	pulsar: {
		...
		category: "Special",
		name: "Pulsar",
		desc: "Ignores Protect and Mirror Move.",
		pp: 5,
		priority: 0,
		flags: { metronome: 1 },
		target: "normal",
