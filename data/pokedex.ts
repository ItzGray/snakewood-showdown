export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	toxicroak: {
		...
		abilities: { 0: "Rain Dish", 1: "Limber" },
		heightm: 1.3,
		weightkg: 44.4,
		color: "Blue",
		prevo: "Croagunk",
	...
	kuriputo: {
		...
		abilities: { 0: "Battle Armor" }, // name in Snakewood is Bulletproof, figure out what it means
		heightm: 0.7,
		weightkg: 4,
		color: "Red",
		eggGroups: ["Grass"],
	...
	dragoone: {
		...
		abilities: { 0: "Pickup", 1: "Battle Armor" }, // Battle Armor name in Snakewood is Bulletproof, figure out what it does
		heightm: 0.8,
		weightkg: 15,
		color: "Brown",
		eggGroups: ["Flying", "Field"],
	...
	skylax: {
		...
		abilities: { 0: "Immunity", 1: "Battle Armor" }, // Battle Armor name in Snakewood is Bulletproof, figure out what it does
		heightm: 4.5,
		weightkg: 1000.1,
		color: "Gray",
		eggGroups: ["Water 1", "Grass"],
